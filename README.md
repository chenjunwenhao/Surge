...
<p align="center">
  <a href="https://github.com/chenjunwenhao/Surge/releases"><img src="https://img.shields.io/badge/Download-v2.4.2-0ea5e9?style=for-the-badge" /></a>
  ...
  <table align="center">
    <tr>
      <td align="center" width="280">
        ...
        <a href="https://github.com/chenjunwenhao/Surge/releases/download/v2.4.2/Surge-2.4.2-arm64.dmg">
      ...
      <td align="center" width="280">
        ...
        <a href="https://github.com/chenjunwenhao/Surge/releases/download/v2.4.1/Surge-2.4.1-portable-win-x64.zip">
...
**Surge 不做大而全。** Navicat、DBeaver、TablePlus 都在试图连接所有数据库——PostgreSQL、SQLite、MongoDB、Redis……Surge 只做一件事：**让 MySQL 操作快到极致。**

### 💰 价格

| | Surge | Navicat | DBeaver | TablePlus | MySQL Workbench |
|---|---|---|---|---|---|
| | 🆓 **免费 MIT** | 💸 $1,099+/年 | 🆓 免费 / Pro $199 | 💸 $89 买断 | 🆓 免费 |

### ⭐ 体验评分

| 维度 | Surge | Navicat | DBeaver | TablePlus | Workbench |
|---|---|---|---|---|---|
| 启动速度 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐ |
| 界面简洁 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐ | ⭐⭐⭐⭐⭐ | ⭐⭐ |
| SQL 补全 | ⭐⭐⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐ | ⭐⭐⭐ |
...
<p>
多数据库工具为了兼容所有引擎，每一步操作都要兜底最差情况——SQL 补全不敢做上下文推断、格式化只能做关键字换行、导出不问你表里有多少数据、事务超时可以无限挂起。
</p>
<p>
<strong>Surge 的专一带来的是每个细节的深度打磨</strong>：<code>SELECT</code> 后的列对齐知道该补哪些表字段、JOIN 层级有语义缩进、自研 400 行格式化引擎做给人看的排版、导出前先查 <code>information_schema</code> 告诉你这表有多大。
</p>
